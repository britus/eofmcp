...
public:
    explicit IMCPResourceService(QObject *pParent = nullptr)
        : QObject(pParent)
    {}
...
public:
     ...
     */
    virtual bool add(const QString &strUri, const QString &strName, const QString &strDescription, const QString &strMimeType, std::function<QString()> contentProvider) = 0;
     ...
     * @endcode
     */
    virtual bool add(const QString &strUri, const QString &strName, const QString &strDescription, const QString &strFilePath, const QString &strMimeType = QString()) = 0;
