...
enum class LogLevel { Debug = 0, Info = 1, Warning = 2, Critical = 3, Fatal = 4 };
...
public:
    ...
    bool initialize(const QString &strLogFilePath = QString(), LogLevel minLevel = LogLevel::Debug, bool bEnableFileLogging = true);
